...
app.get('/health', (req, res) => {
  ...
  res.json({ status: 'healthy', service: 'mcp' });
});

app.post('/api/chat', (req, res) => {
  logger.info('Chat request received', { message: req.body.message });
  res.json({ 
    response: 'This is a mock AI response for your message: ' + req.body.message,
